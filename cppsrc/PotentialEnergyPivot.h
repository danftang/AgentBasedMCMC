...
public:
    static constexpr double kappaRow = -5.0;//-7.5; // exponential coefficient for probabilities of choosing row based on change in infeasibility
    static constexpr double kappaCol = 5.0;//5.0; // exponential coefficient for probabilities of choosing col based on potential energy
