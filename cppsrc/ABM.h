...
#ifndef GLPKTEST_ABM_H
#define GLPKTEST_ABM_H

#include <set>

//template<typename AGENT>
//class ABM {
//    typename AGENT::ActDomain actDomain;
//    typename AGENT::AgentDomain agentDomain;
////    EventDomain<AGENT::AgentDomain,AGENT::ActDomain>  eventDomain;
//
//
//
//
