...
//            kappa(kappa),
//            observations(ABMLikelihood<trajectory_type>::generateObservations(realTrajectory, pMakeObservation, pObserveIfPresent)),
//            basisObj(posterior())
//    {
//    }
//
...
//    };
//
//    ABMLikelihood<trajectory_type> likelihood() {
//        return ABMLikelihood<trajectory_type>(observations, pObserveIfPresent);
//    }
//
